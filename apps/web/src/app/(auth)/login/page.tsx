      ...
      <div className="login-root">
        ...
        <div className="login-left">
          ...
          <p className="login-left-tagline">
            Unlock the potential of<br />persistent AI memory.
          </p>
        </div>
          ...
          <div className="login-form-wrap">
            ...
            {errors.form && (
              <div className="login-alert" role="alert">
                ...
                <div>
                  <p className="login-alert-title">Authentication failed</p>
                  <p className="login-alert-body">
                    Please check your credentials and try again, or reset your password if you&apos;ve forgotten it.
                  </p>
                </div>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} noValidate className="login-form">
              ...
              <div className="lf-row-between">
                ...
                <Link href="/forgot-password" className="lf-link">Forgot password?</Link>
              </div>
            ...
            <p className="lf-footer">
              ...
              <Link href="/signup" className="lf-link">Sign up</Link>
            </p>
